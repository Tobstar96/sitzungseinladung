...
public class Email {
		...
		if(inbox.getMessageCount() >= 1) {
			...
			for ( Message m : inbox.getMessages() ) {
				...
				System.out.println( "Content-Type: " + new ContentType( m.getContentType() ) );*/
					...
					System.out.println("Ungültige Nachricht, Mail löschen");
					...
					if(arr[0].equalsIgnoreCase("Sitzungseinladung")) {
						...
						System.out.println("Keine Sitzungseinladung, Mail löschen");
						m.setFlag(Flags.Flag.DELETED, true);
					}
				}
			}
	...
	public void openInbox() throws MessagingException {
		System.out.println("Inbox öffnen");
		...
		inbox = folder;
		System.out.println("Inbox geöffnet");
	}

	public void closeInbox() throws MessagingException {
		System.out.println("POP3 Verbindung schließen");
		inbox.close(true);
